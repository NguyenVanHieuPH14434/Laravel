                ...
                <div class="col-lg-12">
                        ...
                        <div class="list-group" id="orderList">
                            @foreach($listOrders as $item)
                                ...
                                <a href="{{route('listOrderDetails', $item->id)}}" class="list-group-item list-group-item-action list-group-item-primary"><label for="">Mã đơn hàng: {{$item->code_order}}</label></a>
